...
insert into tb_produto (cd_produto,nm_produto,vl_produto,ds_produto)
values(null,'pinto de peru',11.99,'6 7');

insert into tb_produto (cd_produto,nm_produto,vl_produto,ds_produto)
values(null,'leite condençado',359.99,'leite condençado de qualidade mediana');
